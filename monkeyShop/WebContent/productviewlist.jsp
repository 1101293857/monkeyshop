...
<div class="address">
    <div class="wrapper clearfix"><a href="indexselect">首页</a><span>/</span><a
            href="selectproductlist?cid=${cate5.CATE_ID }">${cate5.CATE_NAME}</a><span>/</span><a href="#" class="on">【最家】${p.PRODUCT_NAME }</a>
    </div>
</div><!-----------------------Detail------------------------------>
<div class="detCon">
        ...
        <div class="proCon clearfix">
            ...
            <div class="fr intro">
                <div class="title"><h4>【最家】${p.PRODUCT_NAME }</h4>
                    <p>【${p.PRODUCT_DESCRIPTION }】</p><span>￥${p.PRODUCT_PRICE }.90</span></div>
                <div class="proIntro"><p>颜色分类</p>
                    ...
                    <p>数量&nbsp;&nbsp;库存<span>${p.PRODUCT_NUM}</span>件</p>
                ...
                <a href="javascript:shopAdd(${p.PRODUCT_ID },'s')"><p class="cart fr">
                    加入购物车</p></a></div>
            </div>
        </div>
    </div>
        ...
        <div class="seeList">
        	<c:forEach var = "cl" items="${Clist }">
              	<a href="selectproductview?id=${cl.PRODUCT_ID }">
		            <dl>
		                <dt><img src="images/product/${cl.PRODUCT_FILENAME }"></dt>
		                <dd>${cl.PRODUCT_NAME }</dd>
		                <dd>￥${cl.PRODUCT_PRICE }.20</dd>
		            </dl>
		        </c:forEach>
        </a><a href="#">
            <dl>
