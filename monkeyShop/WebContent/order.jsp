    ...
    <div class="orderCon wrapper clearfix">
        ...
        <div class="orderR fr">
            <div class="msg"><h3>订单内容<a href="cart.html" class="fr">返回购物车</a></h3><!--------ul---------------->
                <c:forEach items="${shoplist }" var="nihao">
                <ul class="clearfix">
                    <li class="fl"><img src="images/product/${nihao.CART_P_FILENAME }"></li>
                    <li class="fl"><p>${nihao.CART_P_NAME }</p>
                        <p>颜色分类：烟灰色玻璃瓶</p>
                        <p>数量：${nihao.CART_QUANTITY }</p></li>
                    <li class="fr">￥${nihao.CATY_PRICE }</li>
                </ul>
                </c:forEach>
                <ul class="clearfix">
