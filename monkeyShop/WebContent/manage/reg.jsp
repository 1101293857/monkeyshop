...
<body><!-------------------reg-------------------------->
<div class="reg">
    <form action="#" method="post"><h1><a href="index.html"><img src="file:///D:/javaproject/monkeyShop/WebContent/img/logo.png"></a></h1>
        <p>用户注册</p>
        ...
        <p class="txtL txt"><input class="code" type="text" name="" value="" placeholder="验证码"><img
                src="monkeyShop/WebContent/img/temp/code.jpg"></p>
