                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <c:forEach var="u" items="${catelist}">
                        	...
                        	<c:if test="${u.CATE_PARENT_ID==0 }">
                      		<tr>
                      			<td>${u.CATE_ID }</td>
                      			<td>|-${u.CATE_NAME }</td>
                      			<td><a href="admin_tocateupdate?id=${u.CATE_ID}">修改</a> <a href="javascript:catedel(${u.CATE_ID})">删除</a></td>
                            </tr>
                            <c:forEach var="ucate" items="${catelist}">
                            	<c:if test="${ucate.CATE_PARENT_ID==u.CATE_ID }">
	                            	<tr>
		                      			<td>${ucate.CATE_ID }</td>
		                      			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|-${ucate.CATE_NAME }</td>
		                      			<td><a href="admin_tocateupdate?id=${ucate.CATE_ID}">修改</a> <a href="javascript:catedel(${ucate.CATE_ID})">删除</a></td>
	                                </tr>
                                </c:if>
                            </c:forEach>
                            </c:if>
