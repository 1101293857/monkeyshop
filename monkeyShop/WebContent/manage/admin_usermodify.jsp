        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/monkeyShop/manage/admin_douserupdate" method="post" id="myform" name="myform">
                    <inout type="hidden" name="userstatus" value="${user.USER_STATUS }">
                    
                    <inout type="hidden" name="cpage" value="${cpage }">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="mail" size="50" value="${user.USER_EMAIL}" type="text">
                                </td>
                            </tr>
                            <tr>
