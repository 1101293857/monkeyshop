...
public class LMONKEY_USER {
			...
			public LMONKEY_USER(String uSER_ID, String uSER_NAME, String uSER_PASSWORD, String uSER_SEX,
					 String uSER_IDENITY_CODE, String uSER_EMAIL, String uSER_MOBILE,
					String uSER_ADDRESS, int uSER_STATUS) {
				super();
				USER_ID = uSER_ID;
				USER_NAME = uSER_NAME;
